package com.murdix.painpills.parser
...
class KaggleParserTest extends FlatSpec with Matchers {
  "The parser" should "parse 5 random lines correctly" in {
    ...
    val maybePainPills1: Option[PainPills] = KaggleParser.parser(line1)
    val maybePainPills2: Option[PainPills] = KaggleParser.parser(line2)
    val maybePainPills3: Option[PainPills] = KaggleParser.parser(line3)
    val maybePainPills4: Option[PainPills] = KaggleParser.parser(line4)
    val maybePainPills5: Option[PainPills] = KaggleParser.parser(line5)
